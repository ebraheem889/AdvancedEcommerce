                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> اضافة الأسعار
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> اضافة الأسعار </h4>
                                    ...
                                    <div class="form-group">
                                        <div class="card-body">
                                            ...
                                            <!-- to stop the validation on the photo -->
                                                <div class="form-body">
                                                    <h4 class="form-section"><i class="ft-home"></i> الأسعار الخاصة
                                                        بالمنتج </h4>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                    ...
                                                                    <select name="special_price_type" class="select2 form-control" multiple>
                                                                        <optgroup label="من فضلك ادخل النوع">
